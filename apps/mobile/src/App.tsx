...
const appLinking = {
  prefixes: [
    Linking.createURL("/"),
    // App URL scheme, not a Tailwind dark-mode utility.
    // oxlint-disable-next-line t3code/no-mobile-uniwind-theme-escape-hatches
    "t3code-after-dark://",
    "t3code-after-dark-dev://",
    "t3code-after-dark-preview://",
  ],
