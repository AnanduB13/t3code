...
export function ThreadRouteScreen(props: ThreadRouteScreenProps) {
  ...
  const stillHydrating = threadRouteIsHydrating({
    ...
    detailStatus: threadSelection.selectedThreadDetailState.status,
    detailHasError: Option.isSome(threadSelection.selectedThreadDetailState.error),
  });
    ...
    <>
      ...
      >
        <ThreadDetailScreen
          ...
          queuedMessages={composer.selectedThreadPendingOutboxMessages}
