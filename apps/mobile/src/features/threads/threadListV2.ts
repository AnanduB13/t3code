 ...
 *
 * Five visual states, four colors: color is reserved for "act now"
 * (approval), "in motion" (working), "broken" (failed), and successful
 * completion. Ready is the unlabeled resting state when no outcome exists.
 */
