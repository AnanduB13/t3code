  ...
  return (
    <PresentationSource identifier={sourceIdentifier} style={{ width: 224, maxWidth: "100%" }}>
      <Pressable
        ...
        accessibilityValue={{
          text: props.sizeBytes === undefined ? "Image" : formatAttachmentSize(props.sizeBytes),
        }}
      ...
      >
        ...
        <View className="min-w-0 flex-1">
          ...
          <Text className="text-xs text-foreground-muted" numberOfLines={1}>
            {props.sizeBytes === undefined ? "Image" : formatAttachmentSize(props.sizeBytes)}
          </Text>
        </View>
      </Pressable>
    </PresentationSource>
          ...
          <View className="mt-1.5 flex-row flex-wrap gap-2">
            {imageAttachments.map((attachment) => (
              <MessageAttachmentImage
                ...
                className="size-24 rounded-xl bg-subtle-strong"
                onPressPreview={props.onPressPreview}
              />
            ))}
          </View>
