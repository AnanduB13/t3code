...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.agentsHermesCreateCronJob]: AuthOrchestrationOperateScope,
  [WS_METHODS.agentsHermesUpdateCronJob]: AuthOrchestrationOperateScope,
  [WS_METHODS.agentsHermesPauseCronJob]: AuthOrchestrationOperateScope,
  [WS_METHODS.agentsHermesResumeCronJob]: AuthOrchestrationOperateScope,
  [WS_METHODS.agentsHermesRunCronJob]: AuthOrchestrationOperateScope,
  [WS_METHODS.agentsHermesDeleteCronJob]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.skillsCreateGlobal]: AuthOrchestrationOperateScope,
