...
import AfterDarkLastVisitedAt from "./Migrations/045_ProjectionThreadLastVisitedAt.ts";
import Migration0054 from "./Migrations/054_AfterDarkMainCompatibility.ts";
...
const migrationEntries = [
  ...
  [44, "ClearAutomaticProjectModelDefaults", Effect.andThen(AfterDarkCompatibility, Migration0044)],
  [45, "ProjectionProjectsAutoPull", Effect.andThen(Migration0045, AfterDarkLastVisitedAt)],
  ...
  [54, "AfterDarkMainCompatibility", Migration0054],
] as const;
