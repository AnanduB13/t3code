...
export const COMPOSER_INLINE_PLUGIN_CHIP_CLASS_NAME =
  "inline-flex max-w-full select-none items-center gap-[0.33em] rounded-[0.5em] border border-blue-500/25 bg-blue-500/12 px-[0.5em] py-[0.08em] font-medium text-[0.86em] leading-[1.1] text-blue-700 align-middle dark:text-blue-300";
...
export const PLUGIN_CHIP_ICON_SVG = `<svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.85" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="12" x="3" y="4" rx="2"/><path d="M8 20h8"/><path d="M12 16v4"/></svg>`;
