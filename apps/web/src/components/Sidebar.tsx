...
export default function Sidebar() {
  ...
  useEffect(() => {
    if (activeProjectRef?.projectId === GENERAL_CHATS_PROJECT_ID) {
  ...
  }, [activeProjectRef?.projectId, activeProjectScopeKey, routeThreadKey, setProjectScopeKey]);
  ...
  }, [nowMinute, optimisticDrop, visibleProjectKeys, serverConfigs, snoozeWakeTick, threads]);
  ...
  const threadSearchResults = useMemo(
    ...
    [searchableThreads, threadSearchQuery, threadSearchMatchByKey, projectDisplayNameByKey],
  );
  ...
  const settledResetKey = `${sidebarMode}:${projectScopeKey ?? "all"}`;
        ...
        fixedHeader={
          ...
          <SidebarGroup className="relative z-[1] p-[var(--sidebar-content-inset)] pt-1">
            ...
            <SidebarThreadHeader
              ...
              hasProjects={sidebarMode !== "chats" && projectGroups.length > 0}
              projectScope={
                <Combobox
                  items={projectScopeItems}
                        ...
                        return (
                          ...
                          >
                            ...
                            <ProjectActivityIndicators
                              activity={
                                project
                                  ? (projectActivityByScopeKey.get(project.projectKey) ?? {
                                      runningCount: 0,
                                      unreadCount: 0,
                                    })
                                  : allProjectsActivity
