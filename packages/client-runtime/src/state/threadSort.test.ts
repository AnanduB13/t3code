...
describe("sortThreads", () => {
  ...
  it("falls back to creation when the user message timestamp is invalid", () => {
...
describe("sortActiveThreadsByOrderKey", () => {
  it("keeps unarranged threads ahead of the saved order without promoting a reopened thread", () => {
