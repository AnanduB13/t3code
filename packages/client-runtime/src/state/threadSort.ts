...
/** Unarranged threads move on a user message; reopening restores their place. */
...
/** Unarranged threads lead the active list in latest-user-message order. Arranged threads follow
    their saved keys; assistant activity leaves both groups in place. */
