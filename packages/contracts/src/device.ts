 ...
 *
 * Devices live on a host: the environment server or a configured SSH machine.
 * Host ids scope discovery, actions, and streams because different machines
 * can report the same device id.
 *
 * @module Device
 */
