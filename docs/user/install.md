...
After Dark installers and updates use the After Dark release repository. The `npx t3@latest`
package runs upstream T3 Code.
...
([Install vp](https://github.com/AnanduB13/t3code#install-vp)):

```bash
git clone https://github.com/AnanduB13/t3code
...
Download a release from [GitHub Releases](https://github.com/AnanduB13/t3code/releases),
which includes the After Dark edition. These package-manager entries install upstream T3 Code:
...
On mobile, Antigravity setup is also available in **Settings → Environments**. Runtime installation
and Google sign-in belong to the chosen environment, including when the phone connects remotely.
