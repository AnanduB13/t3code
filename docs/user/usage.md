...
## After Dark history views

Web and desktop retain **7 days**, **30 days**, **90 days**, and **All time**, alongside **Past 24h**.
Cost and token views update both totals and charts. Device coverage and the **T3 Code** versus
**Terminal** breakdown remain available across connected machines. Limits use the same environment
selection without replacing historical totals.

Mobile keeps its cost-focused history view and **Past 24h** hourly detail, alongside subscription
limits. Refreshing rescans connected environments.
