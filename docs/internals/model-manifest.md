...
A newer bundled manifest takes precedence over an older cached manifest before the next remote
refresh. Bump `updatedAt` when changing the bundled model catalog.
